...
MPLAYER_CFG := --target=i686-mingw32 --enable-cross-compile --cc=$(HOST)-gcc \
	--host-cc=$(BUILD)-gcc --as=$(HOST)-as --nm=$(HOST)-nm \
	--ar=$(HOST)-ar --ranlib=$(HOST)-ranlib --windres=$(HOST)-windres \
	--enable-static --enable-w32threads --enable-live \
	--extra-cflags="-march=k8-sse3 -msse3 -mfpmath=sse"
